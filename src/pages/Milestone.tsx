...
export const Milestone = () => {
  return (
    <div className='relative text-white px-5 md:px-48'>
      <div className="flex-col justify-center items-center gap-10 flex py-10">
        ...
        <div className="text-[#B3B3B3]">My design journey was a mix of trial, error, and a whole lot of learning. Here's how it really went down.
        </div>
      </div>
      ...
      <section
        id="testimonials"
        className="w-full space-y-5 py-24"
      >
        <div className="flex-col justify-center items-center gap-10 flex py-10">
