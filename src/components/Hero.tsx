...
export const Hero = () => {
  return (
    <>
      <section className="flex flex-col gap-4 items-start md:w-1/2 px-5  md:px-24 py-14 md:py-28 xl:py-18">
        <p className="text-sm md:text-base text-white/50 md:w-10/12">
          Hey, I'm Armaan
        </p>
        <main className="text-3xl md:text-7xl">
          <h1 className="inline font-first text-white">
            UI/UX DESIGNER
          </h1>
        </main>
        <p className=" text-sm md:text-base p-3 md:text-nowrap text-white bg-gradient-to-r from-transparent to-white/10 rounded-full">
          I design intuitive, user-friendly digital experiences by turning complex ideas into simple solutions.
        </p>
      </section>
      <div className="flex flex-row items-center justify-center gap-5 text-white py-5 md:py-0">
